 ...
 * Damian Marciniak
 */
package jchess.view.panelview.jchessview;
...
import jchess.view.panelview.jchessview.newgame.NewGameWindow;
...
public class JChessTabbedPane extends JTabbedPane implements MouseListener, ImageObserver {
	...
	public JChessTabbedPane() {
		...
		this.unclickedAddIcon = ResourceLoader.loadImage(Images.ADD_TAB);
		this.clickedAddIcon = ResourceLoader.loadImage(Images.CLICKED_ADD_TAB);
	...
	public void addTab(String title, Component component, Icon closeIcon) {
		...
		Log.log("Present number of tabs: " + this.getTabCount());
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (tabNumber >= 0) {
			...
			if (rect.contains(e.getX(), e.getY())) {
				Log.log("Removing tab with " + tabNumber + " number!...");
			...
			Log.log("newGame by + button");
			this.showNewGameWindow();
		}
		// Log.log("x:" +e.getPozX()+" y: "+e.getPozY()+" x:"+this.addIconRect.x+"
		// y::"+this.addIconRect.y+" width:"+this.addIconRect.width+" height:
		// "+this.addIconRect.height);
	}
